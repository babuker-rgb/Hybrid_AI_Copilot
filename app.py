...
# FINAL – WITH ADJUSTABLE CONSTRAINTS FOR SPREAD
# ================================================================
...
# ================================================================
# CONSTANTS (will be overridden by sliders)
# ================================================================
DEFAULT_D_MIN = 0.72
DEFAULT_D_MAX = 0.99
...
def generate_pinn_data(n_samples, random_state=42):
    ...
    D_heckel = np.clip(D_heckel, 0.6, 0.99)   # relaxed for fallback data
...
class NSGAIIOptimizer:
    ...
    # The rest of NSGA-II methods (non_dominated_sort, crowding_distance, crossover, mutate, tournament, run) are identical to previous versions.
    # To save space, I'll include a placeholder – the full code is provided in the final answer.
